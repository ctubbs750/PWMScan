...
if __name__ == "__main__":
    ...
    python_path = "python" # the python 2.7 interpreter 
    parallelize_path = "workflow/scripts/parallelize.py" # the parall. dispatcher
    matrix_scan_path = "resources/software/PWMScan/matrix_scan" # matrix_scan
    ...
    try:
        ...
        sys.stdout.write(results) # type: ignore
